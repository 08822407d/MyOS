...
#define	_MYOS_ARCHCONST_H_
    ...
    #define INDEX_CS_TASK       04
    #define INDEX_DS_TASK       05
    ...
    #define SELECTOR_CS_TASK    SEG_SELECTOR(INDEX_CS_TASK)|TASK_PRIVILEGE
    #define SELECTOR_DS_TASK    SEG_SELECTOR(INDEX_DS_TASK)|TASK_PRIVILEGE
